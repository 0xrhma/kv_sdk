      ...
      case VEntry:
        switch (sym)
        {
          ...
          case '{':
            ...
            KvObj* _cobj = (gobj(ctx->iobj - 1));
            _cobj->child = gobj(ctx->iobj);
            ...
            struct KvResult *res)
{
  ...
  // print_dbg(CS_BOLD CS_YELLOW"dub_info::total mem prediction for KvParse::
